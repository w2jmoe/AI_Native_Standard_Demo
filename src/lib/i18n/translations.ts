...
export const translations = {
  en: {
    ...
    earlyExperiment: "Early Experiment v1.7",
    earlyExperimentDesc:
    ...
    hiringDemoNote:
      "This report is part of an early experiment to validate AI work-capability assessment. It is not a job-match result and should not be used as a formal hiring decision at this stage.",
  ...
  zh: {
    ...
    hiringDemoNote:
      "本报告用于验证 AI 工作能力评估方式。它不是岗位匹配结果，当前阶段不作为正式招聘决策依据。",
