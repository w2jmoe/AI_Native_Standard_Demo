...
export const translations = {
  en: {
    ...
    earlyExperiment: "Early Experiment v1.5",
    earlyExperimentDesc:
    ...
    hiringDemoNote: "AI-generated hiring signal for demo — not a final hiring decision.",
    ...
    detailedScoresLabel: "Detailed Scores",
    aiNativeLevelLabel: "AI Native Level",
    confidenceLabel: "Confidence",
    suitableRolesLabel: "Suitable Roles",
    keyReasonsLabel: "Key Reasons",
    evidenceSummaryLabel: "Evidence Summary",
    evidenceHighlightsIntro: "Why these capabilities were inferred:",
